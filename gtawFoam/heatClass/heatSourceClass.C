...
Foam::heatSourceClass::heatSourceClass(
    ...
    sourceVel("sourceVel", dimLength, sourcePropertiesDict),
    ...
    sourceOmega("sourceOmega", dimLength, sourcePropertiesDict),
    sourcePenn("sourcePenn", dimLength, sourcePropertiesDict),
    ...
    sourceStartTime("sourceStartTime", dimTime, sourcePropertiesDict),
    sourcePauseTime("sourcePauseTime", dimTime, sourcePropertiesDict), 
    sourceEndTime("sourceEndTime", dimTime, sourcePropertiesDict),
    source3EndTime("source3EndTime", dimTime, sourcePropertiesDict.lookupOrDefault<scalar>("source3EndTime", 1e3)),
    sourcePower("sourcePower", dimLength, sourcePropertiesDict),
    
    sourceC_C("sourceC_C", dimless, sourcePropertiesDict),
    sourceFieldCut("sourceFieldCut", dimless, sourcePropertiesDict),

    sourcePause(sourcePropertiesDict.lookup("sourcePause")),
